<template>
    <div class="flex h-screen bg-gray-950 text-gray-50">
        ...
        <aside
            ...
            <!-- Search -->
            <div class="px-5 py-4">
                <UInput v-model="q" placeholder="Search..." icon="i-heroicons-magnifying-glass" size="sm"
                    color="neutral" variant="outline" class="text-sm" />
            </div>
            ...
            <!-- Footer -->
            <div class="px-5 py-4 border-t border-gray-800 text-sm text-gray-400">
