<template>
  <div class="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#04060a]">
    ...
    <!-- soft vignette + teal ambient light (non-interactive) -->
    <div
    ...
    >
      ...
      <div class="absolute -bottom-32 -right-32 w-[28rem] h-[28rem] rounded-full bg-[#06312a] opacity-40 blur-[140px]"></div>
      <!-- faint concentric radial rings -->
      <div class="absolute inset-0 bg-[radial-gradient(circle_at_10%_20%,rgba(20,184,166,0.02),transparent_40%)]" />
    </div>
    ...
    >
      ...
      <div class="flex flex-col items-center text-center mb-8">
        <h1 class="text-5xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
          Welcome to
          <span
            class="ml-2 bg-clip-text text-transparent bg-gradient-to-r from-teal-300 to-lime-300"
          >
            Mpira Stats
          </span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div>
          <form @submit.prevent="handleSubmit" class="space-y-4">
            <UInput
              ...
              class="bg-transparent text-white placeholder-gray-400 border-gray-700"
              required
            />
            ...
            <div class="flex items-center justify-between mt-2">
              <label class="flex items-center gap-2 text-sm text-gray-300">
                <input v-model="remember" type="checkbox" class="h-4 w-4 rounded bg-gray-800 accent-teal-400" />
                Remember me
              </label>
        ...
        <!-- right: feature / callout to match home layout visual weight -->
        <div class="hidden md:flex flex-col justify-center pl-6">
          <div class="mb-6">
            <div class="inline-flex items-center px-3 py-2 rounded-full bg-gradient-to-r from-teal-600/10 to-transparent border border-gray-700/30">
              <span class="text-sm text-teal-300 font-semibold">⚽ Featured</span>
            </div>
          </div>

          <div class="p-6 rounded-xl border border-gray-800/30 bg-gradient-to-b from-[#071018]/50 to-transparent">
...
async function handleSubmit() {
  ...
  try {
    ...
    const token = useCookie("accessToken", { maxAge: 60 * 15 })
...
<style scoped>
/* subtle animated gradient clip for the word "Mpira Stats" if you want motion */
